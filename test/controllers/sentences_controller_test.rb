...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post sentences_url, params: { sentence: { language_code: @sentence.language_code, sentence: @sentence.sentence, source_id: @sentence.source_id } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { language_code: @sentence.language_code, sentence: @sentence.sentence, source_id: @sentence.source_id } }
